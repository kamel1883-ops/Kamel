...
// 6 شرائح: البداية / الناشئة / المتوسطة / المتقدمة / الكبرى (حتى 1,000) / مخصّصة (أكثر من 1,000 — تواصل مع المبيعات)
...
export const PRICING_TIERS = [
  ...
  { id: "enterprise", min: 401, max: 1000, tier: "الكبرى", yearly: 9900, setup: 0, year1: 9900 },
  { id: "custom", min: 1001, max: Infinity, tier: "مخصّصة", yearly: null, setup: 0, year1: null, custom: true, contact: true },
];
