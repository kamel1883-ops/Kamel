// توقيع بريدي موحّد يُلحق بنهاية كل رسالة تُرسلها منصة جداره.
// صيغة HTML احترافية (مطابقة لهوية جداره: كحلي + ذهبي) + نسخة نصية احتياطية.
  ...
  <table role="presentation" dir="rtl" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse">
    <tr>
      ...
      <td style="width:120px;vertical-align:middle;text-align:center;padding:18px 16px;border-left:1.5px solid #C5A059;background:#1a1333">
        <img src="${LOGO_URL}" alt="جداره" width="64" height="64" style="display:block;margin:0 auto;border-radius:12px" />
        <div style="margin-top:8px;color:#d4af37;font-weight:700;font-size:13px">جداره</div>
      </td>
      ...
      <td style="vertical-align:middle;padding:16px 18px;text-align:right">
        ...
        <div style="font-weight:700;font-size:14px;color:#C5A059;margin-bottom:10px">جداره لإدارة الموارد البشرية</div>
...
export const EMAIL_FOOTER =
  "\n\n— الإدارة العامة — جداره لإدارة الموارد البشرية —\n" +
