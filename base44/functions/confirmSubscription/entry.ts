  ...
  try {
    ...
    if (clientEmail) {
      try {
        await base44.asServiceRole.integrations.Core.SendEmail({
          to: clientEmail,
          subject: 'تم تفعيل اشتراككم السنوي في منصة جداره',
          ...wrapEmailContent(
            'السلام عليكم ورحمة الله وبركاته،\n\n' +
            'أهلاً بكم في منصة «جداره لإدارة الموارد البشرية». تم بنجاح تفعيل اشتراككم السنوي وإطلاق حساب منشأتكم.\n\n' +
            'بيانات الاشتراك:\n' +
            'المنشأة: ' + name + '\n' +
            'نوع الباقة: سنوي\n' +
            ...
            '1) ادخلوا بوابة الشركات في منصة جداره.\n' +
