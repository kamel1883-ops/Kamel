...
const SECTIONS = {
  ...
  "end-of-service": {
    icon: "FileText", titleAr: "نهاية الخدمة", titleEn: "End of service",
    nameField: "prepared_by_name", idField: "prepared_by_id",
    fields: [
      { k: "employee_id", ar: "الموظف *", type: "employee", req: true, resolve: ["employee_name", "employee_number", "national_id", "department", "position", "hire_date"], col: 1 },
      { k: "last_working_date", ar: "آخر يوم عمل *", type: "date", req: true, col: 1 },
      { k: "reason", ar: "سبب الإنهاء", type: "text", col: 1 },
      { k: "reason_note", ar: "المرجع النظامي", type: "text", col: 1 },
      { k: "basis", ar: "أساس الحساب", type: "text", col: 1 },
      { k: "monthly_wage", ar: "الأجر الشهري", type: "number", col: 1 },
      { k: "eos_amount", ar: "مكافأة نهاية الخدمة", type: "number", col: 1 },
      { k: "leave_balance_days", ar: "رصيد الإجازات", type: "number", col: 1 },
      { k: "leave_cash", ar: "تعويض الإجازات", type: "number", col: 1 },
      { k: "ticket_amount", ar: "تعويض التذكرة", type: "number", col: 1 },
      { k: "deduction_amount", ar: "مستحقات دائنة", type: "number", col: 1 },
      { k: "addition_amount", ar: "مستحقات إضافية", type: "number", col: 1 },
      { k: "total_settlement", ar: "إجمالي المخالصة", type: "number", col: 1 },
      { k: "generated_date", ar: "تاريخ المخالصة", type: "date", col: 1 },
      { k: "status", ar: "الحالة", type: "status", options: { draft: "مسودة", awaiting_finance: "بانتظار المالية", completed: "مكتملة", rejected: "مرفوضة", settled: "مصفاة", cancelled: "ملغاة" }, col: 1 },
    ],
    columns: [
      { k: "employee_name", ar: "الموظف" },
      { k: "last_working_date", ar: "آخر يوم" },
      { k: "total_settlement", ar: "الإجمالي" },
      { k: "status", ar: "الحالة", options: { draft: "مسودة", awaiting_finance: "بانتظار المالية", completed: "مكتملة", rejected: "مرفوضة", settled: "مصفاة", cancelled: "ملغاة" } },
    ],
  },
  attendance: {
    icon: "Fingerprint", titleAr: "الحضور والانصراف", titleEn: "Attendance",
    nameField: "prepared_by_name", idField: "prepared_by_id",
    fields: [
      { k: "employee_id", ar: "الموظف *", type: "employee", req: true, resolve: ["employee_name", "employee_user_id", "national_id", "branch_id", "branch_name"], col: 1 },
      { k: "date", ar: "التاريخ *", type: "date", req: true, col: 1 },
      { k: "check_in", ar: "الحضور", type: "text", ph: "HH:MM", col: 1 },
      { k: "check_out", ar: "الانصراف", type: "text", ph: "HH:MM", col: 1 },
      { k: "status", ar: "الحالة", type: "status", options: { present: "حاضر", absent: "غائب", late: "متأخر", leave: "إجازة", holiday: "عطلة" }, col: 1 },
      { k: "work_hours", ar: "ساعات العمل", type: "number", col: 1 },
      { k: "break_minutes", ar: "دقائق الراحة", type: "number", col: 1 },
      { k: "notes", ar: "ملاحظات", type: "textarea", col: 2 },
    ],
    columns: [
      { k: "employee_name", ar: "الموظف" },
      { k: "date", ar: "التاريخ" },
      { k: "check_in", ar: "الحضور" },
      { k: "check_out", ar: "الانصراف" },
      { k: "status", ar: "الحالة", options: { present: "حاضر", absent: "غائب", late: "متأخر", leave: "إجازة", holiday: "عطلة" } },
    ],
  },
  leaves: {
    icon: "Calendar", titleAr: "الإجازات", titleEn: "Leaves",
    nameField: "prepared_by_name", idField: "prepared_by_id",
    fields: [
      { k: "employee_id", ar: "الموظف *", type: "employee", req: true, resolve: ["employee_name", "employee_user_id"], col: 1 },
      { k: "leave_type", ar: "نوع الإجازة *", type: "select", req: true, options: { annual: "سنوية", sick: "مرضية", emergency: "طارئة", unpaid: "بدون أجر", maternity: "وضع", permission: "استئذان" }, col: 1 },
      { k: "start_date", ar: "البداية *", type: "date", req: true, col: 1 },
      { k: "end_date", ar: "النهاية *", type: "date", req: true, col: 1 },
      { k: "days_count", ar: "عدد الأيام", type: "number", col: 1 },
      { k: "reason", ar: "السبب", type: "text", col: 2 },
      { k: "status", ar: "الحالة", type: "status", options: { pending_manager: "بانتظار المدير", manager_approved: "موافقة المدير", hr_approved: "موافقة الموارد", awaiting_finance: "بانتظار المالية", paid: "مصروف", completed: "مكتملة", rejected: "مرفوضة", approved: "معتمدة" }, col: 1 },
    ],
    columns: [
      { k: "employee_name", ar: "الموظف" },
      { k: "leave_type", ar: "النوع", options: { annual: "سنوية", sick: "مرضية", emergency: "طارئة", unpaid: "بدون أجر", maternity: "وضع", permission: "استئذان" } },
      { k: "start_date", ar: "البداية" },
      { k: "end_date", ar: "النهاية" },
      { k: "status", ar: "الحالة", options: { pending_manager: "بانتظار المدير", manager_approved: "موافقة المدير", hr_approved: "موافقة الموارد", awaiting_finance: "بانتظار المالية", paid: "مصروف", completed: "مكتملة", rejected: "مرفوضة", approved: "معتمدة" } },
    ],
  },
  "business-trips": {
    icon: "Plane", titleAr: "رحلات العمل", titleEn: "Business trips",
    nameField: "prepared_by_name", idField: "prepared_by_id",
    fields: [
      { k: "employee_id", ar: "الموظف *", type: "employee", req: true, resolve: ["employee_name", "employee_user_id"], col: 1 },
      { k: "trip_type", ar: "نوع الرحلة *", type: "select", req: true, options: { internal: "داخلية", external: "خارجية" }, col: 1 },
      { k: "destination", ar: "الوجهة", type: "text", col: 1 },
      { k: "purpose", ar: "الغرض", type: "text", col: 2 },
      { k: "start_date", ar: "البداية *", type: "date", req: true, col: 1 },
      { k: "end_date", ar: "النهاية *", type: "date", req: true, col: 1 },
      { k: "days_count", ar: "عدد الأيام", type: "number", col: 1 },
      { k: "transport_mode", ar: "وسيلة التنقل", type: "select", options: { plane: "طائرة", car: "سيارة", bus: "حافلة", train: "قطار", none: "بدون" }, col: 1 },
      { k: "transport_cost", ar: "تكلفة التنقل", type: "number", col: 1 },
      { k: "accommodation_cost", ar: "تكلفة الإقامة", type: "number", col: 1 },
      { k: "per_diem", ar: "بدل الانتداب اليومي", type: "number", col: 1 },
      { k: "other_costs", ar: "تكاليف أخرى", type: "number", col: 1 },
      { k: "total_cost", ar: "إجمالي التكلفة", type: "number", col: 1 },
      { k: "status", ar: "الحالة", type: "status", options: { pending_manager: "بانتظار المدير", manager_approved: "موافقة المدير", awaiting_finance: "بانتظار المالية", approved: "معتمدة", in_progress: "قيد التنفيذ", completed: "مكتملة", cancelled: "ملغاة", rejected: "مرفوضة" }, col: 1 },
    ],
    columns: [
      { k: "employee_name", ar: "الموظف" },
      { k: "destination", ar: "الوجهة" },
      { k: "start_date", ar: "البداية" },
      { k: "end_date", ar: "النهاية" },
  ...
  vehicles: {
    icon: "Car", titleAr: "سجل المركبات", titleEn: "Vehicles registry",
    nameField: "prepared_by_name", idField: "prepared_by_id",
    fields: [
      { k: "plate_number", ar: "رقم اللوحة *", type: "text", req: true, col: 1 },
      { k: "vehicle_type", ar: "نوع المركبة", type: "select", options: { sedan: "سيدان", suv: "دفع رباعي", van: "فان", truck: "شاحنة", bus: "حافلة", other: "أخرى" }, col: 1 },
      { k: "brand", ar: "الماركة", type: "text", col: 1 },
      { k: "model", ar: "الموديل", type: "text", col: 1 },
      { k: "year", ar: "سنة الصنع", type: "number", col: 1 },
      { k: "color", ar: "اللون", type: "text", col: 1 },
      { k: "insurance_number", ar: "رقم التأمين", type: "text", col: 1 },
      { k: "insurance_expiry", ar: "انتهاء التأمين", type: "date", col: 1 },
      { k: "license_expiry", ar: "انتهاء رخصة السير", type: "date", col: 1 },
      { k: "inspection_expiry", ar: "انتهاء الفحص الدوري", type: "date", col: 1 },
      { k: "status", ar: "الحالة", type: "status", options: { active: "سارية", under_maintenance: "تحت الصيانة", out_of_service: "خارج الخدمة" }, col: 1 },
      { k: "notes", ar: "ملاحظات", type: "textarea", col: 2 },
    ],
    columns: [
      ...
      { k: "model", ar: "الموديل" },
      { k: "year", ar: "السنة" },
      { k: "license_expiry", ar: "انتهاء الرخصة" },
      { k: "status", ar: "الحالة", options: { active: "سارية", under_maintenance: "تحت الصيانة", out_of_service: "خارج الخدمة" } },
    ],
  },
  fleet: {
    icon: "Car", titleAr: "توكيلات المركبات", titleEn: "Vehicle delegations",
    nameField: "created_by_name", idField: "created_by_id",
    fields: [
