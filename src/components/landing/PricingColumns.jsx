      ...
      <div className="bg-white rounded-[2rem] p-6 sm:p-10 text-[#0B2545] shadow-xl shadow-black/10 border border-[#E2E8F0]">
              ...
              >
                ...
                <div className="lg:w-[260px] lg:shrink-0 flex flex-col justify-center">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {featured && (
                      <span className="inline-flex items-center gap-1 text-xs font-bold rounded-full px-3 py-1 text-white" style={{ background: NAVY }}>
                  ...
                  <div className="mt-1 text-sm font-semibold" style={{ color: GREY }}>{t.range}</div>
                  <p className="mt-2 text-xs leading-relaxed" style={{ color: "#718096" }}>{t.note}</p>
                </div>
                ...
                <div className="flex-1 min-w-0 border-t lg:border-t-0 pt-4 lg:pt-0" style={{ borderColor: BORDER }}>
                  <div className="text-sm font-bold mb-2.5" style={{ color: NAVY }}>{includes}</div>
        ...
        <div className="mt-6 rounded-2xl overflow-hidden flex flex-col lg:flex-row" style={{ border: `2px solid ${NAVY}`, background: "#fff", boxShadow: "0 18px 40px -18px rgba(11,37,69,.35)" }}>
          ...
          <div className="lg:w-[320px] p-6 sm:p-8 flex flex-col justify-center" style={{ background: NAVY, color: "#fff" }}>
            ...
            <div className="text-sm font-medium mt-1" style={{ color: "#A0AEC0" }}>{isAr ? "/ 30 يوماً" : "/ 30 days"}</div>
          ...
          <div className="flex-1 p-6 sm:p-8 flex flex-col justify-center">
            ...
            <div className="text-sm mb-4" style={{ color: GREY }}>
