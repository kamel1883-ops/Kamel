...
const KEYWORDS = [
  { text: "إدارة الرواتب", top: "18%", left: "12%", delay: 0, dur: 7, size: "text-sm" },
  { text: "Payroll", top: "26%", left: "78%", delay: 0.8, dur: 8, size: "text-base font-bold" },
  { text: "إدارة الأداء", top: "38%", left: "8%", delay: 1.4, dur: 9, size: "text-sm" },
  { text: "إدارة الموظفين", top: "44%", left: "82%", delay: 0.4, dur: 7.5, size: "text-sm" },
  { text: "حماية الأجور", top: "58%", left: "16%", delay: 1.8, dur: 8.5, size: "text-sm" },
  { text: "مدد", top: "64%", left: "72%", delay: 0.2, dur: 7, size: "text-base font-bold" },
  { text: "قوى", top: "30%", left: "44%", delay: 1.1, dur: 9.5, size: "text-sm" },
  { text: "مكتب العمل", top: "72%", left: "40%", delay: 0.6, dur: 8, size: "text-sm" },
  { text: "مقيم", top: "52%", left: "55%", delay: 1.6, dur: 9, size: "text-sm" },
  { text: "تم", top: "20%", left: "60%", delay: 0.2, dur: 7.5, size: "text-sm" },
];
