...
export default function BankTransferScreen() {
  return (
    <div dir="rtl" className="w-72 rounded-[2.5rem] border-[7px] border-primary bg-card p-3 text-foreground shadow-2xl">
      <div className="mx-auto mb-3 h-1.5 w-16 rounded-full bg-primary" />
      <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
        ...
        <p className="mt-1 text-xs text-muted-foreground">مستحقات إجازة سنوية</p>
