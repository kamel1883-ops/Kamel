...
function RelinkEmailDialog({ open, onClose, tenant, isAr, onSaved }) {
  ...
  const f = isAr ? {
    ...
    note: "استخدم هذا الإجراء عندما ينسى العميل بريده القديم تماماً. سيتم تحديث بريد المنشأة وتوجيه دعوة لإنشاء حساب بالإيميل الجديد. بعد ذلك يستطيع العميل تسجيل الدخول عبر بوابة الشركات بالإيميل الجديد + الرقم الموحد + كلمة المرور، أو اتباع «نسيت كلمة المرور» لاستلام رابط التعيين على البريد الجديد. جميع بيانات المنشأة (الموظفون، الرواتب، الطلبات، الحضور، التقييمات...) محفوظة بالكامل ولا تُفقد؛ الحساب الجديد يحمل صلاحية المشرف ويرى كل البيانات السابقة كما هي.",
    cancel: "إغلاق", confirm: "ربط الإيميل الجديد",
    invalid: "بريد إلكتروني غير صالح",
    sameErr: "البريد الجديد مطابق للبريد الحالي",
    ok: (em) => `تم ربط «${em}» بالمنشأة وإرسال دعوة إنشاء حساب إليه. اطلب من العميل إكمال الدعوة (أو «نسيت كلمة المرور») ثم الدخول بالإيميل الجديد + الرقم الموحد + كلمة المرور. بيانات المنشأة محفوظة بالكامل ومرئية للحساب الجديد دون أي فقدان.`,
