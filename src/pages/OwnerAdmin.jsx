...
function RelinkEmailDialog({ open, onClose, tenant, isAr, onSaved }) {
  ...
  const f = isAr ? {
    ...
    note: "استخدم هذا الإجراء عندما يتواصل معك العميل بعد نسيان بريده القديم تماماً. سيتم استبدال بريد المنشأة بالإيميل الجديد وإرسال رسالة تفعيل إلى بريده الجديد توجّهه لاستخدام «نسيت كلمة المرور» بالإيميل الجديد + الرقم الموحد. لا تُرسل له رسالة تسجيل جديد — فقط رسالة التفعيل. بيانات المنشأة (الموظفون، الرواتب، الحقوق، المركبات، الطلبات...) محفوظة بالكامل ومرتبطة بالرقم الموحّد الثابت لا بالإيميل، فلا تُفقد شيئاً عند تغيير البريد.",
    cancel: "إغلاق", confirm: "ربط الإيميل الجديد",
    invalid: "بريد إلكتروني غير صالح",
    sameErr: "البريد الجديد مطابق للبريد الحالي",
    ok: (em) => `تم استبدال بريد المنشأة بـ«${em}» وإرسال رسالة التفعيل إلى بريده الجديد. رسالة التفعيل توجّهه لفتح «نسيت كلمة المرور» وكتابة الإيميل الجديد + الرقم الموحّد لاستلام رابط تعيين كلمة المرور، ثم الدخول بالإيميل الجديد + الرقم الموحّد + كلمة المرور الجديدة. بيانات المنشأة محفوظة بالكامل ومرتبطة بالرقم الموحّد الثابت، ولم يُرسل له رابط تسجيل جديد.`,
