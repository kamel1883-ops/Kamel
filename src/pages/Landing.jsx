...
export default function Landing() {
  ...
  const t = isAr ? {
    ...
    heroDesc: "من «جدارة» — منصة سعودية واحدة متكاملة تجمع كل حوانب إدارة رأس المال البشري في مكان واحد: ملفات الموظفين ووثائقهم، الحضور والبصمة الذاتية من الجوال، الإجازات والسلف ورحلات العمل المرفوعة من الموظف والمشتركة مع الإدارة لحظياً، الرواتب وحماية الأجور، التأمينات الاجتماعية، نهاية الخدمة وفق نظام العمل، إدارة الأداء والتدريب والتطوير، التخطيط التعاقبي والقوة العاملة، التحليلات اللحظية، الأسطول والمركبات، التراخيص الحكومية، والإنذارات الذكية المرتبطة بنظام العمل — مع بوابة موظف ذاتية تدعم 7 لغات، ومسار موافقات متعدد المراحل، وتكاملات حكومية ذكية، وتصميم فخم، وحسابات دقيقة وفق الأنظمة السعودية.",
  ...
  return (
    <div className="min-h-screen bg-[#0b1120] text-white antialiased" dir={isAr ? "rtl" : "ltr"}>
      <AssistantAvatar mode="public" tone="dark" />
