...
const features = [
  ...
  { icon: Plug, title: "التكاملات الذكية", desc: "استيراد البصمات، بوابات دفع إلكتروني (Visa/مدى)، وروابط حكومية قادمة (أبشر/مقيم)." },
  ...
  return (
    <div className="min-h-screen bg-[#0b1120] text-white antialiased" dir="rtl">
      ...
      <section id="integrations" className="max-w-7xl mx-auto px-5 py-14">
        <SectionHead tag="أتمتة ذكية" title="تكاملات تربط نظامك بالواقع" />
