...
export default function Landing() {
  ...
  const t = isAr ? {
    ...
    goalsLabel: "أهدافنا", goalsText: "نمكّن عملاءنا من الكفاءة والإمتثال والنمو، ونختصر الوقت والجهد، ونعزز السعودة وقرارات الموارد البشرية بالبيانات، ونبني شراكة طويلة الأمد قائمة على الثقة والشفافية.",
