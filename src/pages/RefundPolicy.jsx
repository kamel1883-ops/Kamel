...
export default function RefundPolicy() {
  ...
  const ar = {
    ...
    updated: "2026",
    intro: "تُطبَّق هذه الشروط على اشتراكات منصة «جداره» لإدارة الموارد البشرية، وهي صياغة تفصيلية لما نصّت عليه المادة (5) «فترة التجربة والاسترداد» والمادة (6) «التجديد السنوي وإلغاء الاشتراك» من عقد الاشتراك السنوي المبرم بين الطرفين، وتُعدّ جزءاً مكمّلاً له.",
    sections: [
      ...
      { title: "مدة معالجة الاسترداد ووسيلة الرد", body: "تُراجع «جداره» الطلب وتُصدر قرارها خلال مدة لا تتجاوز عشرة (10) أيام عمل من تاريخ استلامه. وتُردّ المبالغ المستحقة بتحويل بنكي إلى نفس الحساب الذي تم السداد منه، خلال مدة لا تتجاوز أربعة عشر (14) يوم عمل من إقرار الاسترداد." },
