...
export default function AffiliateProgram() {
  ...
  const steps = isAr ? [
    { icon: Link2, t: "احصل على رابطك", d: "سجّل بياناتك ويصلك رابط إحالة خاص بك من فريق جداره." },
  ...
  const sections = isAr ? [
    { title: "التعريف بالبرنامج", body: "برنامج شركاء «جداره» هو برنامج تسويق بالعمولة يتيح للشريك الترويج لمنصة جداره لإدارة الموارد البشرية مقابل عمولة على العملاء الجدد الذين يشتركون من خلال رابط الشريك. وتُتتبّع الإحالات والعمولات عبر أنظمة جداره المعتمدة للتحقق من صحة الإحالة والدفعة المؤهلة." },
    { title: "نسبة العمولة — 7% من أول اشتراك فقط", items: [
      ...
      "لا تُحتسب أي عمولة على التجديد السنوي للعميل ولا على السنوات التالية، إلا باتفاق خطي مستقل مع جداره.",
    ...
    { title: "صرف العمولات", items: [
      ...
      "على الشريك تزويد جداره ببيانات بنكية صحيحة ومحدّثة، ولا تتحمّل جداره تأخيراً ناتجاً عن بيانات ناقصة.",
    ] },
    { title: "شروط الترويج", body: "يلتزم الشريك بالترويج بطريقة واضحة وصادقة وغير مضلّلة، ويُمنع عليه:", items: [
      ...
      "الوعد بنتائج أو خصومات غير مصرّح بها من جداره.",
      "الرسائل المزعجة (Spam) أو أساليب التسويق الاحتيالية.",
      "إنشاء حسابات وهمية أو الإحالة الذاتية للحصول على عمولة.",
      "نشر محتوى مسيء أو غير قانوني أو يضر بسمعة جداره.",
    ] },
    { title: "استخدام العلامة التجارية", body: "يجوز للشريك استخدام اسم «جداره» وموادها التسويقية المعتمدة لغرض الترويج ضمن البرنامج فقط، دون تعديل الشعار أو الإيحاء بوجود شراكة رسمية أو تمثيل قانوني للمنصة دون موافقة مكتوبة." },
    { title: "مراجعة الإحالات", body: "تحتفظ جداره بحق مراجعة كل إحالة قبل اعتمادها، ورفض أو إلغاء أي عمولة ناتجة عن نشاط احتيالي أو إحالة ذاتية أو حسابات وهمية أو مخالفة لهذه الشروط أو دفعة مستردة أو ملغاة." },
    { title: "إنهاء المشاركة", body: "يحق لجداره إيقاف أو إنهاء مشاركة أي شريك عند مخالفة الشروط أو إساءة استخدام البرنامج، ويجوز للشريك التوقف في أي وقت. وفي حال الإنهاء بسبب مخالفة أو احتيال، يحق لجداره إلغاء العمولات غير المدفوعة." },
    { title: "تعديل الشروط وحدود المسؤولية", body: "تحتفظ جداره بحق تعديل شروط البرنامج أو نسبة العمولة أو آلية الصرف مستقبلاً، وتُطبَّق التعديلات من تاريخ نشرها. ولا تضمن جداره للشريك عدداً معيناً من الإحالات أو الأرباح، ولا تتحمّل أي خسائر مباشرة أو غير مباشرة. وأي نزاع يُحال إلى الجهات النظامية المختصة في المملكة العربية السعودية." },
  ] : [
    ...
    <div className="min-h-screen bg-[#F6F3FC] text-foreground" dir={isAr ? "rtl" : "ltr"}>
      ...
      <main className="max-w-[1100px] mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold leading-tight text-foreground" style={{ fontFamily: "var(--font-display)" }}>
          {isAr ? "برنامج شركاء جداره" : "Jadara Partners Program"}
        </h1>
        <p className="text-muted-foreground leading-loose mt-4 max-w-3xl">
          {isAr
            ? "اربح 7% من قيمة أول اشتراك لكل منشأة تُحيلها إلى منصة جداره لإدارة الموارد البشرية. العمولة تُستحق مرة واحدة فقط عن أول اشتراك مدفوع، ولا تُحتسب عن التجديد السنوي."
