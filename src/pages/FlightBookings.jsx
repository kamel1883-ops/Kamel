...
function ProviderCard({ providerKey, onSelect, isAr }) {
  ...
  return (
    ...
    >
      <div className="h-28 flex items-center justify-center rounded-xl overflow-hidden">
        <img src={p.logo} alt={isAr ? p.name : p.nameEn} className="max-h-full max-w-full object-contain" />
      </div>
...
export default function FlightBookings() {
  ...
  const t = isAr ? {
    ...
    subtitle: "ابحث عن رحلات الطيران داخل منصة جداره، ثم أكمِل الحجز والدفع مباشرة على موقع المزوّد المختار.",
    pick: "اختر مزوّد الحجز",
    pickSub: "ستنتقل إلى موقع المزوّد لإتمام الحجز والدفع. جداره لا تتلقى أي مبالغ ولا تتحمل مسؤولية الحجز.",
    back: "تغيير المزوّد",
    tripType: "نوع الرحلة",
    oneway: "ذهاب فقط",
    round: "ذهاب وعودة",
