...
export default function About() {
  ...
  const t = isAr ? {
    ...
    whoBody: "تستهدف «جداره» المنشآت الصغيرة والمتوسطة والكبرى على حد سواء، وفرق الموارد البشرية والمالية التي تبحث عن نظام واحد موثوق يوحّد العمليات الإدارية ويقلّل المخاطر التشغيلية والمالية والنظامية، ويمنحها رؤية واضحة على رأس المال البشري عبر لوحات معلومات تفاعلية ومؤشرات لحظية.",
    chip: "مولّد فكرة «جداره» ومصمم منهجها", founderH: "من يبني جداره؟",
    founder: "يقف خلف «جداره» قائد في إدارة رأس المال البشري جمع بين العمق الأكاديمي والخبرة التطبيقية في تصميم حلول رقمية ترفع كفاءة المنشآت وتلتزم بالأنظمة السعودية. حاصل على درجة ",
