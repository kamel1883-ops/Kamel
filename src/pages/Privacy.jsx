...
export default function Privacy() {
  ...
  const ar = {
    ...
    updated: "2026",
    intro: "تلتزم منصة «جداره» لإدارة الموارد البشرية بحماية خصوصية بيانات منشآت عملائها وموظفيهم، وتُطبّق هذه السياسة على كل استخدام للمنصة وبواباتها (بوابة الشركات، بوابة الموظف الذاتية، بوابة المعتمدين، بوابة المالك)، وتُعدّ مكمّلة لأحكام عقد الاشتراك السنوي المبرم بين الطرفين.",
    sections: [
      ...
      { title: "ملكية البيانات", body: "تبقى جميع بيانات المنشأة وموظفيها ملكاً خالصاً للمنشأة (الطرف الثاني)، وتعمل «جداره» عليها بوصفها مشغّلاً للخدمة فقط. ولا نبيع بياناتك ولا نؤجّرها ولا نشاركها مع أي طرف ثالث لأغراض تسويقية." },
      ...
      { title: "استخدام اسم المنشأة وشعارها", body: "وفقاً لما نصّت عليه المادة (11) من عقد الاشتراك، يحق لـ«جداره» إدراج اسم المنشأة وشعارها ضمن قائمة عملائها وملفها التعريفي لأغراض التعريف فقط، ولا يُنشئ ذلك أي التزام أو شراكة قانونية، ويجوز للمنشأة طلب إزالته كتابياً." },
