...
export default function AdDesigns() {
  ...
  const POSTERS = isAr ? [
    {
      id: "team", title: "روح الفريق في جداره", subtitle: "مستوحى من بيئة العمل السعودية",
      tags: ["فِرق", "A4 عمودي"],
      props: {
    ...
    },
    {
      ...
      props: {
        ...
        body: "تقدّم بوابة الموظف الذاتية في جداره الإجازات والسلف وكشوف الرواتب والقرارات والحوافز بضغطة زر، وبسبع لغات.",
