...
const CONTENT = {
  ...
  ar: {
    ...
    hero: "نظام الحضور والانصراف من جداره — تسجيل حضور بالبصمة عبر GPS ضمن نطاق 50 متراً من مقر العمل، استيراد جداول الحضور بالجملة، متابعة التأخر والغياب والإجازة، وتقارير شهرية قابلة للتحميل PDF بشعار المنشأة. للمنشآت في الرياض وجدة والدمام ومكة وباقي المملكة.",
    ...
    features: [
      ...
      { icon: Printer, t: "تقارير شهرية PDF", d: "حمّل تقرير حضور أي شهر سابق PDF بشعار منشأتك وجداره." },
    ...
    faqs: [
      { q: "هل يحتاج نظام الحضور إلى أجهزة بصمة؟", a: "لا — يعتمد جداره على بصمة GPS ضمن نطاق 50 متراً من مقر العمل عبر بوابة الموظف، بديل عملي واقتصادي لأجهزة البصمة التقليدية." },
      { q: "هل يمكنني استيراد جداول الحضور بالجملة؟", a: "نعم — يمكنك رفع ملفات Excel/CSV لتسجيل حضور عدد كبير من الموظفين بنقرة واحدة." },
      { q: "هل يمكنني تحميل تقرير حضور لشهر سابق؟", a: "نعم — يمكنك اختيار أي شهر من الأشهر الماضية الموجودة وتحميل تقرير PDF بشعار منشأتك وشعار جداره." },
    ...
    ctaDesc: "وفّر كلفة الأجهزة وуляحق حضور فريقك بدقة — جرّب نظام حضور جداره مجاناً 30 يوماً.",
    seo: {
      title: "نظام الحضور والانصراف السعودي | بصمة GPS وتقارير PDF — جداره",
      description: "نظام الحضور والانصراف من جداره — بصمة GPS ضمن 50 متراً، استيراد جداول الحضور، ربط بالرواتب، وتقارير شهرية PDF بشعار منشأتك. للشركات في الرياض وجدة والدمام ومكة وباقي السعودية.",
