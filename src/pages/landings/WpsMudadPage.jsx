...
const CONTENT = {
  ...
  ar: {
    ...
    featuresTitle: "ماذا يوفّر جداره لحماية الأجور؟",
    features: [
    ...
    faqs: [
      ...
      { q: "هل يدعم جداره كل البنوك السعودية؟", a: "يدعم جداره تنسيق ملف الإرسال المعتمد من مدد لكل البنوك السعودية." },
      { q: "هل يحفظ جداره نسخة من الملفات المرسلة؟", d: "", a: "يولّد جداره الملفات وفق الهيكل المعتمد ويمكنك أرشفتها محلياً قبل الإرسال." },
    ],
    ctaTitle: "أتمت حماية الأجور في منشأتك",
    ctaDesc: "جرّب جداره مجاناً 30 يوماً وأرسل أول ملف WPS بثقة.",
    seo: {
