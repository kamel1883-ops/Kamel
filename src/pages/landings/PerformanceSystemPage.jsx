...
const CONTENT = {
  ...
  ar: {
    ...
    hero: "نظام إدارة الأداء من جداره يحوّل تقييم الموظفين إلى عملية منظمة وعادلة — أهداف ذكية (SMART)، كفاءات، سلوكيات مهنية، توصيات ترقية ومكافآت، وتتبع مستمر للإنجاز. مصمم للمنشآت السعودية لمتابعة الأداء وتطوير الكفاءات في الرياض وجدة والدمام وباقي المملكة.",
    ...
    faqs: [
      { q: "هل يدعم جداره التقييم التجريبي للموظفين الجدد؟", a: "نعم — يوفّر نوع مراجعة تجريبي (probation) لاتخاذ قرار التثبيت أو الفصل بعد فترة التجربة." },
    ...
    ctaDesc: " جرّب نظام إدارة الأداء من جداره مجاناً 30 يوماً وطوّر فريقك بثقة.",
    seo: {
      title: "نظام إدارة الأداء السعودي | تقييم الموظفين والأهداف — جداره",
      description: "نظام إدارة الأداء من جداره — أهداف SMART، كفاءات، سلوكيات، تقييم متعدد الأطراف وتوصيات ترقية. للمنشآت في الرياض وجدة والدمام ومكة وباقي السعودية.",
