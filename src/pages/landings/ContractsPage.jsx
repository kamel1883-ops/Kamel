...
const CONTENT = {
  ...
  ar: {
    ...
    hero: "أدِر عقود العمل ولوائح المنشأة بسهولة داخل «جداره» — توقيع وتجديد العقود، تنبيهات انتهاء العقود القاربت على الانتهاء، تنفيذ سياسة العمل والجزاءات والإنذارات التصاعدية وفق نظام العمل السعودي، ومتابعة اللوائح التنظيمية دون ورق. نظام موارد بشرية سحابي للمنشآت السعودية.",
    ...
    featuresTitle: "مزايا إدارة العقود واللوائح في جداره",
    features: [
    ...
    faqs: [
      { q: "هل يدعم جداره عقود العمل المحددة والمفتوحة؟", a: "نعم — يدعم أنواع العقود (دوام كامل، جزئي، عقد محدد المدة) مع تتبّع التواريخ." },
      { q: "كيف يتم ربط التنبيهات بنظام العمل؟", a: "يدمج جداره جدول عقود العمل مع تنبيهات انتهاء وتقارير عقود قاربت على الانتهاء." },
    ...
    ctaDesc: "جرّب جداره مجاناً 30 يوماً وأدِر عقود العمل بلا ورق.",
    seo: {
      title: "إدارة العقود واللوائح حسب نظام العمل السعودي | جداره",
