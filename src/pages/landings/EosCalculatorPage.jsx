...
const CONTENT = {
  ...
  ar: {
    ...
    featuresTitle: "مزايا حاسبة نهاية الخدمة في جداره",
    features: [
    ...
    ctaDesc: "جرّب جداره مجاناً 30 يوماً واحسب أول مخالصة بشعار منشأتك.",
    seo: {
      title: "حاسبة مكافأة نهاية الخدمة حسب نظام العمل السعودي | جداره",
