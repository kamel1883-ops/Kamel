...
const DICT = {
  ...
  approvals: {
    ar: {
      ...
      finHistoryTitle: "سجل المعاملات المالية (دائم)",
      finHistorySub: "كل السلف والإجازات والانتدابات والمخالصات التي صُرفت أو اعتمدتها — مرجع تدقيق محفوظ لا يُحذف",
      finHistoryEmpty: "لا توجد معاملات سابقة في سجلك المالي",
      finSearchPh: "بحث برقم الهوية أو الاسم",
      finPaidDate: "تاريخ الصرف",
    ...
    en: {
      ...
      finHistoryTitle: "Financial transactions log (permanent)",
      finHistorySub: "All loans, leaves, trips and settlements you paid or approved — a preserved audit record",
      finHistoryEmpty: "No past transactions in your finance log",
      finSearchPh: "Search by ID or name",
      finPaidDate: "Payment date",
  ...
  decisions: {
    ar: { title: "القرارات الإدارية", subtitle: "القرارات الصادرة لك من إدارة المنشأة — مراجعة والعمل بمضمونها، محفوظة لتاريخها وصيغتها.", empty: "لا توجد قرارات صادرة لك.", issued: "تاريخ الإصدار", effective: "ينفذ بتاريخ", dept: "الإدارة", all: "لجميع الموظفين", ack: "تأكيد الاطلاع", ackDone: "تم الاطلاع", types: { appointment: "تعيين", transfer: "نقل", promotion: "ترقية", assignment: "تكليف", secondment: "إعارة", exemption: "إعفاء", reward: "مكافأة", deduction: "خصم", warning: "إنذار", termination: "إنهاء", policy: "سياسة", other: "قرار" } },
    en: { title: "Administrative Decisions", subtitle: "Decisions issued to you by management — review and comply; preserved with their date and wording.", empty: "No decisions issued for you.", issued: "Issued", effective: "Effective", dept: "Department", all: "All employees", ack: "Acknowledge", ackDone: "Acknowledged", types: { appointment: "Appointment", transfer: "Transfer", promotion: "Promotion", assignment: "Assignment", secondment: "Secondment", exemption: "Exemption", reward: "Reward", deduction: "Deduction", warning: "Warning", termination: "Termination", policy: "Policy", other: "Decision" } },
    hi: { title: "प्रशासनिक निर्णय", subtitle: "प्रबंधन द्वारा आपके लिए जारी निर्णय — समीक्षा करें और पालन करें; तिथि और पाठ के साथ सुरक्षित।", empty: "आपके लिए कोई निर्णय नहीं।", issued: "जारी", effective: "प्रभावी", dept: "विभाग", all: "सभी कर्मचारी", ack: "पावती दें", ackDone: "पावती दी गई", types: { appointment: "नियुक्ति", transfer: "स्थानांतरण", promotion: "पदोन्नति", assignment: "कार्यभार", secondment: "प्रतिनियुक्ति", exemption: "छूट", reward: "पुरस्कार", deduction: "कटौती", warning: "चेतावनी", termination: "समाप्ति", policy: "नीति", other: "निर्णय" } },
    ne: { title: "प्रशासनिक निर्णयहरू", subtitle: "व्यवस्थापनद्वारा जारी निर्णय — समीक्षा गर्नुहोस् र पालना गर्नुहोस्; मिति र पाठसहित सुरक्षित।", empty: "तपाईंका लागि कुनै निर्णय छैन।", issued: "जारी", effective: "प्रभावकारी", dept: "विभाग", all: "सबै कर्मचारी", ack: "पावती दिनुहोस्", ackDone: "पावती भयो", types: { appointment: "नियुक्ति", transfer: "सरुवा", promotion: "बढुवा", assignment: "कार्यभार", secondment: "प्रतिनियुक्ति", exemption: "छूट", reward: "पुरस्कार", deduction: "कटौती", warning: "चेतावनी", termination: "समाप्ति", policy: "नीति", other: "निर्णय" } },
    bn: { title: "প্রশাসনিক সিদ্ধান্ত", subtitle: "ব্যবস্থাপনা থেকে আপনাকে জারি — পর্যালোচনা ও মেনে চলুন; তারিখ ও পাঠ সহ সংরক্ষিত।", empty: "আপনার জন্য কোনো সিদ্ধান্ত নেই।", issued: "জারি", effective: "কার্যকর", dept: "বিভাগ", all: "সকল কর্মচারী", ack: "পাঠ নিশ্চিত", ackDone: "নিশ্চিত হলেন", types: { appointment: "নিয়োগ", transfer: "বদলি", promotion: "পদোন্নতি", assignment: "দায়িত্ব", secondment: "নিযুক্তি", exemption: "ছাড়", reward: "পুরস্কার", deduction: "কর্তন", warning: "সতর্কতা", termination: "সমাপ্তি", policy: "নীতি", other: "সিদ্ধান্ত" } },
    fil: { title: "Mga Administrative Decision", subtitle: "Mga desisyon na inisyu sa iyo ng management — suriin at sundin; preserbado sa petsa at teksto.", empty: "Walang desisyon para sa iyo.", issued: "Inisyu", effective: "Epektibo", dept: "Department", all: "Lahat ng empleyado", ack: "I-confirmang nabasa", ackDone: "Nakumpirma", types: { appointment: "Pagtatalaga", transfer: "Paglipat", promotion: "Promosyon", assignment: "Pag-atas", secondment: "Secondment", exemption: "Eksemsyon", reward: "Gantimpala", deduction: "Deduction", warning: "Babala", termination: "Pagwakas", policy: "Patakaran", other: "Desisyon" } },
    ur: { title: "انتظامی فیصلے", subtitle: "منتظمہ کی طرف سے آپ کو جاری فیصلے — ملاحظہ کریں اور عمل کریں؛ تاریخ اور عبارت کے ساتھ محفوظ۔", empty: "آپ کے لیے کوئی فیصلہ جاری نہیں۔", issued: "جاری", effective: "نافذ", dept: "محکمہ", all: "تمام ملازمین", ack: "مطالعہ کی تصدیق", ackDone: "تصدیق شدہ", types: { appointment: "تقرری", transfer: "تبدیلی", promotion: "ترقی", assignment: "ذمہ داری", secondment: "تعیناتی", exemption: "معافی", reward: "انعام", deduction: "کٹوتی", warning: "تنبیہ", termination: "اختتام", policy: "پالیسی", other: "فیصلہ" } },
  },

  incentives: {
    ar: { title: "الحوافز والمكافآت", subtitle: "الحوافز الصادرة لك من المنشأة — محفوظة لتاريخها وقيمتها وبيانها.", empty: "لا توجد حوافز صادرة لك.", granted: "تاريخ المنح", amount: "المبلغ", types: { bonus: "مكافأة", cash_reward: "مكافأة نقدية", allowance_grant: "بدل مخصص", gift: "هدية", recognition: "تقدير", other: "حافز" } },
    en: { title: "Incentives & Rewards", subtitle: "Incentives granted to you by the organization — preserved with date, value and statement.", empty: "No incentives granted to you.", granted: "Granted", amount: "Amount", types: { bonus: "Bonus", cash_reward: "Cash reward", allowance_grant: "Allowance grant", gift: "Gift", recognition: "Recognition", other: "Incentive" } },
    hi: { title: "प्रोत्साहन और पुरस्कार", subtitle: "संगठन द्वारा आपको प्रदत्त प्रोत्साहन — तिथि, मूल्य और विवरण के साथ सुरक्षित।", empty: "आपके लिए कोई प्रोत्साहन नहीं।", granted: "प्रदान", amount: "राशि", types: { bonus: "बोनस", cash_reward: "नकद पुरस्कार", allowance_grant: "भत्ता अनुदान", gift: "उपहार", recognition: "सम्मान", other: "प्रोत्साहन" } },
    ne: { title: "प्रोत्साहन र पुरस्कार", subtitle: "संस्थाद्वारा तपाईंलाई प्रदान गरिएका प्रोत्साहन — मिति, मूल्य र विवरणसहित सुरक्षित।", empty: "तपाईंका लागि कुनै प्रोत्साहन छैन।", granted: "प्रदान", amount: "रकम", types: { bonus: "बोनस", cash_reward: "नगद पुरस्कार", allowance_grant: "भत्ता अनुदान", gift: "उपहार", recognition: "सम्मान", other: "प्रोत्साहन" } },
    bn: { title: "প্রণোদনা ও পুরস্কার", subtitle: "প্রতিষ্ঠান কর্তৃক আপনাকে প্রদত্ত প্রণোদনা — তারিখ, মূল্য ও বিবরণ সহ সংরক্ষিত।", empty: "আপনার জন্য কোনো প্রণোদনা নেই।", granted: "প্রদান", amount: "পরিমাণ", types: { bonus: "বোনাস", cash_reward: "নগদ পুরস্কার", allowance_grant: "ভাতা অনুদান", gift: "উপহার", recognition: "স্বীকৃতি", other: "প্রণোদনা" } },
