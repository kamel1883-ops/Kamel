...
const DICT = {
  ...
  clock: {
    ar: { noGeo: "الجهاز لا يدعم تحديد الموقع", noAccess: "تعذر الوصول إلى موقعك — فعّل صلاحية الموقع", noWorkplace: "لم يحدد المقر الرسمي — تواصل مع الموارد البشرية", outRange: (d, r) => `أنت خارج نطاق العمل (المسافة ${Math.round(d)} متر). يُسمح بالبصمة ضمن ${r} متر فقط.`, alreadyIn: "تم تسجيل الحضور مسبقاً اليوم", doneIn: "تم تسجيل الحضور بنجاح", needIn: "يجب تسجيل الحضور أولاً", alreadyOut: "تم تسجيل الانصراف مسبقاً", doneOut: "تم تسجيل الانصراف بنجاح", fail: "تعذر التسجيل", title: "البصمة اليومية", sub: (r, d) => `يُسمح بالبصمة فقط من مقر العمل ضمن ${r} متر — بتاريخ ${d}`, in: "الحضور", out: "الانصراف", btnIn: "تسجيل الحضور", btnOut: "تسجيل الانصراف", complete: (h) => `اكتمل تسجيل اليوم (${h} ساعة)`, noWorkplace2: "لم يحدد المقر الرسمي بعد.", myBranch: "الفرع", subBranch: (r, d, n) => `يُسمح بالبصمة من فرع «${n}» ضمن ${r} متر — بتاريخ ${d}`, nowLabel: "الوقت الآن", schedLabel: (s, e) => `الدوام الرسمي: ${s} — ${e}` },
