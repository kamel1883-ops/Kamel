...
// 6 شرائح (البداية / الناشئة / المتوسطة / المتقدمة / الكبرى / مخصّصة للمنشآت بأكثر من 1,000 موظف)
// سعر سنوي واحد فقط، بدون أي رسوم تأسيس. إجمالي السنة الأولى = السعر السنوي.
// الشريحة الأخيرة (مخصّصة) لعدد موظفين أكثر من 1,000 — تتطلب التواصل مع قسم المبيعات لعرض سعر مخصّص.
...
export const PRICING_TIERS_AR = [
  ...
  { id: "enterprise", min: 401, tier: "الكبرى", range: "401 - 1,000 موظف", yearly: 9900, setup: 0, year1: 9900, note: "تغطية واسعة، دعم فني مختص، وربط API — بسعر سنوي ثابت 9,900 ر.س بدون رسوم تأسيس." },
  { id: "custom", min: 1001, tier: "مخصّصة", range: "أكثر من 1,000 موظف", yearly: null, setup: 0, year1: null, custom: true, contact: true, note: "للمنشآت الكبيرة بأكثر من 1,000 موظف — تواصل مع قسم المبيعات لعرض سعر مخصّص يتناسب مع حجم منشأتك.", whatsapp: "966594700782", email: "info@jadara-hr.com" },
];
...
export const PRICING_TIERS_EN = [
  ...
  { id: "enterprise", min: 401, tier: "Enterprise", range: "401 - 1,000 employees", yearly: 9900, setup: 0, year1: 9900, note: "Wide coverage, dedicated technical support, and API integration — flat 9,900 SAR/year, no setup fee." },
  { id: "custom", min: 1001, tier: "Enterprise+", range: "More than 1,000 employees", yearly: null, setup: 0, year1: null, custom: true, contact: true, note: "For large organizations with more than 1,000 employees — contact our sales team for a custom quote tailored to your size.", whatsapp: "966594700782", email: "info@jadara-hr.com" },
];
...
export function tierForCount(count, tiers = PRICING_TIERS_AR) {
  ...
  if (n <= 1000) return tiers[4];
  return tiers[5]; // أكثر من 1,000 موظف — شريحة مخصّصة (تواصل مع المبيعات)
}