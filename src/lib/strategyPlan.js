// الخطة الاستراتيجية لمنصة جداره — مرجع موحّد لقسم "الخطة الاستراتيجية" داخل النظام
...
export const IDENTITY = {
  vision: {
    ar: "أن تكون جداره المنصة السعودية الأولى التي تعتمد عليها المنشآت الصغيرة والمتوسطة في إدارة موظفيها ورواتبها وامتثالها العمالي بالكامل.",
...
export const CHANNELS = [
  ...
  },
  {
    ...
    ar_desc: "المشاركة في ملتقيات الموارد البشرية ومعارض المنشآت الصغيرة (بيبان وما شابه) ببروشور جداره وبطاقات العمل والعرض التجريبي المباشر.",
